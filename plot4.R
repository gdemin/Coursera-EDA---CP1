################################################################################
### script for building plot4.png from Coursera EDA Course Project 1 ############
################################################################################
...
plot(power_cons_data$datetime,power_cons_data$Voltage,
     xlab ="datetime",
     ylab = "Voltage", 
     type="l",
     cex.lab = 0.9
...
plot(power_cons_data$datetime,power_cons_data$Global_reactive_power,
     xlab ="datetime",
